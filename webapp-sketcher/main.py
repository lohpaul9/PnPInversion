...
with open('../data/PIE-Bench_v1/mapping_file.json', 'r') as file:
...
async def serve_image(image_path: str):
    full_image_path = f"../data/PIE-Bench_v1/annotation_images/{image_path}"
...
async def save_image(file: UploadFile = File(...), image_path: str = ""):
    ...
    output_filename = f"../data/PIE-Bench_v1/annotation_images/{filename}_sketch.png"  # Save in the same directory
